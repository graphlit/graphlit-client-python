...
class GetEventEvent(BaseModel):
    ...
    location: Optional["GetEventEventLocation"]
    h_3: Optional["GetEventEventH3"] = Field(alias="h3")
...
class GetEventEventLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetEventEventH3(BaseModel):
