...
class QueryMedicalStudiesMedicalStudiesResults(BaseModel):
    ...
    links: Optional[list[Optional["QueryMedicalStudiesMedicalStudiesResultsLinks"]]]
    workflow: Optional["QueryMedicalStudiesMedicalStudiesResultsWorkflow"]
    location: Optional["QueryMedicalStudiesMedicalStudiesResultsLocation"]
    h_3: Optional["QueryMedicalStudiesMedicalStudiesResultsH3"] = Field(alias="h3")
...
class QueryMedicalStudiesMedicalStudiesResultsLinks(BaseModel):
    uri: Optional[Any]
    link_type: Optional[LinkTypes] = Field(alias="linkType")
    excerpts: Optional[str]


class QueryMedicalStudiesMedicalStudiesResultsWorkflow(BaseModel):
    id: str
    name: str


class QueryMedicalStudiesMedicalStudiesResultsLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class QueryMedicalStudiesMedicalStudiesResultsH3(BaseModel):
