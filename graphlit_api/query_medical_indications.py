...
class QueryMedicalIndicationsMedicalIndicationsResults(BaseModel):
    ...
    location: Optional["QueryMedicalIndicationsMedicalIndicationsResultsLocation"]
    h_3: Optional["QueryMedicalIndicationsMedicalIndicationsResultsH3"] = Field(
        alias="h3"
    )
...
class QueryMedicalIndicationsMedicalIndicationsResultsLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class QueryMedicalIndicationsMedicalIndicationsResultsH3(BaseModel):
