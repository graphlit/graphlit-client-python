...
class GetMedicalDrugMedicalDrug(BaseModel):
    ...
    location: Optional["GetMedicalDrugMedicalDrugLocation"]
    h_3: Optional["GetMedicalDrugMedicalDrugH3"] = Field(alias="h3")
...
class GetMedicalDrugMedicalDrugLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetMedicalDrugMedicalDrugH3(BaseModel):
