...
class UpsertWorkflowUpsertWorkflowExtractionJobsConnector(BaseModel):
    ...
    hume: Optional["UpsertWorkflowUpsertWorkflowExtractionJobsConnectorHume"]
...
class UpsertWorkflowUpsertWorkflowExtractionJobsConnectorHume(BaseModel):
    confidence_threshold: Optional[float] = Field(alias="confidenceThreshold")
...
class UpsertWorkflowUpsertWorkflowEnrichmentJobsConnector(BaseModel):
    ...
    waterfall: Optional["UpsertWorkflowUpsertWorkflowEnrichmentJobsConnectorWaterfall"]
...
class UpsertWorkflowUpsertWorkflowEnrichmentJobsConnectorWaterfall(BaseModel):
