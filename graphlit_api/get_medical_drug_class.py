...
class GetMedicalDrugClassMedicalDrugClass(BaseModel):
    ...
    state: EntityState
    user: Optional["GetMedicalDrugClassMedicalDrugClassUser"]
    ...
    location: Optional["GetMedicalDrugClassMedicalDrugClassLocation"]
    h_3: Optional["GetMedicalDrugClassMedicalDrugClassH3"] = Field(alias="h3")
...
class GetMedicalDrugClassMedicalDrugClassUser(BaseModel):
    id: str
...
class GetMedicalDrugClassMedicalDrugClassLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetMedicalDrugClassMedicalDrugClassH3(BaseModel):
