...
class QueryMedicalProceduresMedicalProceduresResults(BaseModel):
    ...
    links: Optional[
        list[Optional["QueryMedicalProceduresMedicalProceduresResultsLinks"]]
    ]
    workflow: Optional["QueryMedicalProceduresMedicalProceduresResultsWorkflow"]
    location: Optional["QueryMedicalProceduresMedicalProceduresResultsLocation"]
    h_3: Optional["QueryMedicalProceduresMedicalProceduresResultsH3"] = Field(
        alias="h3"
    )
...
class QueryMedicalProceduresMedicalProceduresResultsLinks(BaseModel):
    uri: Optional[Any]
    link_type: Optional[LinkTypes] = Field(alias="linkType")
    excerpts: Optional[str]


class QueryMedicalProceduresMedicalProceduresResultsWorkflow(BaseModel):
    id: str
    name: str


class QueryMedicalProceduresMedicalProceduresResultsLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class QueryMedicalProceduresMedicalProceduresResultsH3(BaseModel):
