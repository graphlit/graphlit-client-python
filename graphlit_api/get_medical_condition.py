...
class GetMedicalConditionMedicalCondition(BaseModel):
    ...
    state: EntityState
    user: Optional["GetMedicalConditionMedicalConditionUser"]
    ...
    location: Optional["GetMedicalConditionMedicalConditionLocation"]
    h_3: Optional["GetMedicalConditionMedicalConditionH3"] = Field(alias="h3")
...
class GetMedicalConditionMedicalConditionUser(BaseModel):
    id: str
...
class GetMedicalConditionMedicalConditionLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetMedicalConditionMedicalConditionH3(BaseModel):
