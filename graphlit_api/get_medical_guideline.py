...
class GetMedicalGuidelineMedicalGuideline(BaseModel):
    ...
    state: EntityState
    user: Optional["GetMedicalGuidelineMedicalGuidelineUser"]
    ...
    location: Optional["GetMedicalGuidelineMedicalGuidelineLocation"]
    h_3: Optional["GetMedicalGuidelineMedicalGuidelineH3"] = Field(alias="h3")
...
class GetMedicalGuidelineMedicalGuidelineUser(BaseModel):
    id: str
...
class GetMedicalGuidelineMedicalGuidelineLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetMedicalGuidelineMedicalGuidelineH3(BaseModel):
