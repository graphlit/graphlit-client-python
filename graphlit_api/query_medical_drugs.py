...
class QueryMedicalDrugsMedicalDrugsResults(BaseModel):
    ...
    location: Optional["QueryMedicalDrugsMedicalDrugsResultsLocation"]
    h_3: Optional["QueryMedicalDrugsMedicalDrugsResultsH3"] = Field(alias="h3")
...
class QueryMedicalDrugsMedicalDrugsResultsLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class QueryMedicalDrugsMedicalDrugsResultsH3(BaseModel):
