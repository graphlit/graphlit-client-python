...
class GetMedicalIndicationMedicalIndication(BaseModel):
    ...
    state: EntityState
    user: Optional["GetMedicalIndicationMedicalIndicationUser"]
    ...
    location: Optional["GetMedicalIndicationMedicalIndicationLocation"]
    h_3: Optional["GetMedicalIndicationMedicalIndicationH3"] = Field(alias="h3")
...
class GetMedicalIndicationMedicalIndicationUser(BaseModel):
    id: str
...
class GetMedicalIndicationMedicalIndicationLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class GetMedicalIndicationMedicalIndicationH3(BaseModel):
