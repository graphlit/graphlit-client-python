...
class QueryMedicalDevicesMedicalDevicesResults(BaseModel):
    ...
    links: Optional[list[Optional["QueryMedicalDevicesMedicalDevicesResultsLinks"]]]
    workflow: Optional["QueryMedicalDevicesMedicalDevicesResultsWorkflow"]
    location: Optional["QueryMedicalDevicesMedicalDevicesResultsLocation"]
    h_3: Optional["QueryMedicalDevicesMedicalDevicesResultsH3"] = Field(alias="h3")
...
class QueryMedicalDevicesMedicalDevicesResultsLinks(BaseModel):
    uri: Optional[Any]
    link_type: Optional[LinkTypes] = Field(alias="linkType")
    excerpts: Optional[str]


class QueryMedicalDevicesMedicalDevicesResultsWorkflow(BaseModel):
    id: str
    name: str


class QueryMedicalDevicesMedicalDevicesResultsLocation(BaseModel):
    latitude: Optional[float]
    longitude: Optional[float]


class QueryMedicalDevicesMedicalDevicesResultsH3(BaseModel):
